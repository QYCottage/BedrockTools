...
const std::array<SignatureDefinition, SignatureCount> definitions{{
    ...
    SignatureDefinition{SignatureId::SurvivalModeDestroyBlock, "08 20 43 39 C8 00 00 34 28 BB 01 D0 08 A1 66 39 68 00 00 36 E0 03 1F 2A C0 03 5F D6 D5 EF FF 17"},
